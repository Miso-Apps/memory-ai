const en = {
  ...
  profile: {
    ...
    goToRecall: 'Open Recall',
    openDismissed: 'Open Dismissed',
    lastUpdated: 'Last updated: {{time}}',
    insightThisWeek: 'INSIGHT THIS WEEK',
    weeklyInsightFallback: 'You captured {{count}} memories this week.',
    activity4Weeks: 'Activity past 4 weeks',
    activitySummary: '{{count}} captures across {{days}} active days',
    activityNoData: 'No capture activity in the last 4 weeks yet.',
  ...
  account: {
    ...
    googleNoPassword: 'Your account uses Google sign-in and has no password to change.',
    signOut: 'Sign out',
    deleteWarning:
  ...
  memory: {
    ...
    actionThinkAbout: '✦ Think about this memory',
    ...
    reflectionTitle: 'AI Reflection',
    reflectionFailed: 'Could not generate reflection right now. Please try again.',
    reflecting: 'Reflecting…',
    cachedReflection: 'Loaded from cache',
  },
  ...
  capture: {
    ...
    linkAlreadyExistsTitle: 'Link already saved',
    linkAlreadyExistsMessage: 'This URL is already in your memories.',
    openExistingMemory: 'Open existing memory',
    ...
    toolbarVoiceA11y: 'Record voice memory',
    toolbarImageA11y: 'Attach image memory',
    toolbarLinkA11y: 'Add a link memory',
    justNow: 'just now',
  ...
  login: {
    ...
    checkEmailSubtitle: "We've sent a verification link to {{email}}. Open it to activate your account.",
    checkEmailHint: 'Tap the link in the email — then come back and sign in. No link? Check your spam folder or resend below.',
    resendVerification: 'Resend verification email',
    resendSuccess: 'Email sent',
    resendSuccessMessage: 'A new verification link has been sent. Check your inbox.',
  ...
  recall: {
    ...
    aiChatPromptSeed: 'What have I been thinking about most recently?',
    askAI: 'Ask AI:',
    reasonCategoryMatch: 'You keep coming back to this topic',
    reasonRepeatedTopic: 'You keep coming back to this topic',
    reasonVoiceRecap: 'Voice note worth replaying',
    reasonLinkRevisit: 'Link worth revisiting',
    reasonRecentlySaved: 'Saved recently',
    reasonUserPinned: 'You marked this to remember later',
    reasonOnThisDay: 'On this day in a past year',
    reasonNotViewed: 'Not reviewed recently',
    reasonSemanticCluster: 'Related to your recent memory patterns',
    reasonFallback: 'Recall suggestion',
  },
} as const;
