const vi = {
  ...
  account: {
    ...
    confirmWithPassword: 'Xác nhận bằng mật khẩu của bạn',
    ...
    googleNoPassword: 'Tài khoản của bạn đăng nhập qua Google và không có mật khẩu để thay đổi.',
    signOut: 'Đăng xuất',
    deleteWarning:
  ...
  privacy: {
    ...
    exportLoading: 'Đang chuẩn bị xuất dữ liệu…',
    ...
    dataDeleted: 'Đã xóa toàn bộ dữ liệu thành công',
  },
  ...
  capture: {
    ...
    toolbarVoiceA11y: 'Ghi âm ký ức bằng giọng nói',
    toolbarImageA11y: 'Đính kèm ký ức hình ảnh',
    toolbarLinkA11y: 'Thêm ký ức liên kết',
    justNow: 'vừa xong',
    alwaysPrivate: 'Luôn riêng tư',
    // Rich/block editor
  ...
  login: {
    ...
    checkEmailSubtitle: 'Chúng tôi đã gửi liên kết xác minh đến {{email}}. Mở email để kích hoạt tài khoản.',
    checkEmailHint: 'Nhấn vào liên kết trong email — rồi quay lại ứng dụng để đăng nhập. Không thấy? Kiểm tra thư mục spam hoặc gửi lại bên dưới.',
    resendVerification: 'Gửi lại email xác minh',
    resendSuccess: 'Đã gửi email',
    resendSuccessMessage: 'Liên kết xác minh mới đã được gửi. Kiểm tra hộp thư đến của bạn.',
