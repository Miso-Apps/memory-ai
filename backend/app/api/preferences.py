...
def _to_dict(p: UserPreferences) -> dict:
    ...
    return {
        ...
        "theme_mode": p.theme_mode.value if hasattr(p.theme_mode, "value") else str(p.theme_mode),
        "accent_color": p.accent_color,
        "default_capture_type": p.default_capture_type.value if hasattr(p.default_capture_type, "value") else str(p.default_capture_type),
...
async def update_preferences(
    ...
    if update.default_capture_type is not None:
        ...
        prefs.default_capture_type = DefaultCaptureType(update.default_capture_type.value)
