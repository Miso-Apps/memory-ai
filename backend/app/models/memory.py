from sqlalchemy import Column, String, Text, Integer, DateTime, Boolean, ForeignKey, func, Enum
...
class Memory(Base):
    ...
    embedding = Column(Vector(EMBEDDING_DIM), nullable=True)  # pgvector embedding for semantic search
    ...
    last_viewed_at = Column(DateTime(timezone=True), nullable=True)  # tracks when user opened detail
